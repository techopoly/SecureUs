    ...
    <div className={styles.homePage}>
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>
            Empowering Women to Lead in Cybersecurity
          </p>
          <p className={styles.heroDescription}>
            Join a sisterhood of women breaking barriers in cybersecurity. Learn, grow, and thrive 
            in a supportive community designed by women, for women. Your journey to becoming a 
            cybersecurity leader starts here.
          </p>
      ...
      <section className={styles.empowermentSection}>
        <div className={styles.container}>
          <h2 className={styles.sectionTitle}>Breaking Barriers, Building Futures</h2>
          <p className={styles.empowermentText}>
          ...
          <div className={styles.statsGrid}>
            <div className={styles.statCard}>
              ...
              <div className={styles.statSubtext}>Let's change this together</div>
            </div>
            <div className={styles.statCard}>
              <div className={styles.statIcon}>💰</div>
              <div className={styles.statNumber}>68%</div>
              <div className={styles.statLabel}>Women Use Smartphone</div>
              <div className={styles.statSubtext}>Growing population of women onboarding</div>
            </div>
            <div className={styles.statCard}>
              <div className={styles.statIcon}>🚀</div>
              <div className={styles.statNumber}>40%</div>
              <div className={styles.statLabel}>Gender Gap in Mobile</div>
              <div className={styles.statSubtext}>Your opportunity awaits</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.componentsSection}>
        <div className={styles.container}>
          ...
          <p className={styles.sectionSubtitle}>Designed with women's learning preferences in mind</p>
          
          <div className={styles.componentsGrid}>
            {/* Video Tutorials */}
            <div className={styles.componentCard}>
              <div className={styles.componentIcon}>🎥</div>
              <h3 className={styles.componentTitle}>Interactive Video Learning</h3>
              <p className={styles.componentDescription}>
                Learn at your own pace with bite-sized, engaging videos. Our female instructors 
                explain complex cybersecurity concepts in relatable, easy-to-understand language.
              </p>
              <ul className={styles.featureList}>
                <li>Female-led instruction</li>
            ...
            <div className={styles.componentCard}>
              <div className={styles.componentIcon}>🎯</div>
              <h3 className={styles.componentTitle}>Confidence-Building Quizzes</h3>
              <p className={styles.componentDescription}>
                Build your confidence with supportive assessments. Our quizzes focus on practical 
                application and provide encouraging feedback to help you grow.
              </p>
              <ul className={styles.featureList}>
                <li>Encouraging feedback</li>
                <li>Progress celebration</li>
                <li>Skill-building focus</li>
                <li>Multiple attempts encouraged</li>
              </ul>
            ...
            <div className={styles.componentCard}>
              <div className={styles.componentIcon}>💬</div>
              <h3 className={styles.componentTitle}>Sisterhood Support Network</h3>
              <p className={styles.componentDescription}>
                Connect with like-minded women, find mentors, share experiences, and support 
                each other's growth in a safe, judgment-free environment.
              </p>
              <ul className={styles.featureList}>
                <li>Women-only community</li>
      ...
      <section className={styles.whySection}>
        <div className={styles.container}>
          <h2 className={styles.sectionTitle}>Why Women Choose SecureUs</h2>
          <div className={styles.benefitsGrid}>
            <div className={styles.benefitItem}>
              <div className={styles.benefitIcon}>🌺</div>
              <h4>Women-Centered Approach</h4>
              <p>Content designed understanding how women learn best, with supportive language and encouraging feedback</p>
            </div>
            <div className={styles.benefitItem}>
              <div className={styles.benefitIcon}>🤝</div>
              <h4>Mentorship & Support</h4>
              <p>Connect with successful women in cybersecurity who understand your journey and can guide your growth</p>
            </div>
            <div className={styles.benefitItem}>
              <div className={styles.benefitIcon}>💼</div>
              <h4>Career-Focused Learning</h4>
              <p>Practical skills that directly apply to real cybersecurity roles, with interview prep and career guidance</p>
            </div>
            <div className={styles.benefitItem}>
              <div className={styles.benefitIcon}>🌟</div>
              <h4>Confidence Building</h4>
              <p>Overcome impostor syndrome with structured learning that celebrates progress and builds expertise</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.testimonialsSection}>
        <div className={styles.container}>
          ...
          <div className={styles.testimonialsGrid}>
            ...
            <div className={styles.testimonialCard}>
              <p className={styles.testimonialText}>
                "Finally, a cybersecurity platform that understands women's learning styles. 
      ...
      <section className={styles.ctaSection}>
        <div className={styles.container}>
          <h2 className={styles.ctaSectionTitle}>Ready to Shape the Future of Cybersecurity?</h2>
          <p className={styles.ctaDescription}>
            Join thousands of women who are building their cybersecurity careers with confidence, 
            support, and success. Your journey to leadership starts today.
          </p>
          <div className={styles.ctaButtons}>
            <Link to="/video" className={styles.primaryCta}>Start Your Journey</Link>
            <Link to="/quiz" className={styles.secondaryCta}>Assess Your Skills</Link>
          </div>
        </div>
      </section>
    </div>
